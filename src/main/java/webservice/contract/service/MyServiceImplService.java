 ...
 * 
 */
@WebServiceClient(name = "MyServiceImplService", targetNamespace = "http://www.example.org/myService/", wsdlLocation = "file:/D:/workspaces/JavaDemo/src/META-INF/wsdl/myService.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/D:/workspaces/JavaDemo/src/META-INF/wsdl/myService.wsdl");
