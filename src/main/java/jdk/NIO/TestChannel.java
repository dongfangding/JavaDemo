...
public class TestChannel {
	...
	public void test4() throws IOException {
		RandomAccessFile raf1 = new RandomAccessFile("Java NIO.pdf", "rw");
		...
		// 4. 聚集写入
		RandomAccessFile raf2 = new RandomAccessFile("Java NIO4.pdf", "rw");
	...
	public void test3() throws IOException {
		...
		FileChannel outChannel = FileChannel.open(Paths.get("Java NIO3.pdf"), StandardOpenOption.WRITE,
	...
	public void test1() {// 10874-10953
		...
		try {
			...
			fos = new FileOutputStream("Java NIO1.pdf");
